...
ROLES="control0"
for ROLE in $ROLES; do openstack flavor create --id auto --ram 32768 --disk 37 --vcpus 5 $ROLE ; done
ROLES="compute0 compute1 compute2"
for ROLE in $ROLES; do openstack flavor create --id auto --ram 32768 --disk 37 --vcpus 7 $ROLE ; done
